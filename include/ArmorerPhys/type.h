...
using SparseMatfIter = SparseMatf::InnerIterator;
using SparseMatd = Eigen::SparseMatrix<double>;
using SparseMatdIter = SparseMatd::InnerIterator;
using SparseRowMatd = Eigen::SparseMatrix<double, Eigen::RowMajor>;
using SparseRowMatdIter = SparseRowMatd::InnerIterator;
